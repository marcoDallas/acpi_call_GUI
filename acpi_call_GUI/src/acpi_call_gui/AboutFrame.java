...
public class AboutFrame extends JFrame implements ActionListener{
    ...
    private static final String HOME_PAGE="https://github.com/marcoDallas/acpi_call_GUI";
	...
	public AboutFrame() {
		...
		JLabel lblAcpicallguisystemd = new JLabel("acpi_call_GUI");
		...
		JLabel lblNewLabel_1 = new JLabel("Version: "+ACGFrame.VERSION_ID);
		...
		JLabel lblNewLabel = new JLabel("Copyright (C) "+ACGFrame.COPYRIGHT_YEARS+" Marco Dalla Libera");
